        ...
        if (status == true)
        {
            ...
            if (Input.GetMouseButtonDown(0))
            {
...

                {
                    ...
                    //round 1
                    if (counter == 0 & hit.collider.name == "1_W=2_D=16 Center (4.5, 12.5, 0)")                            
                    {
                        counter++;                                                                                         
                        Debug.Log(hit.point);
                    ...
                    else if (counter == 1 & hit.collider.name == "2_W=2_D=16 Center (20.5, 12.5, 0)")                      
                    {
                        counter++;                                                                                         
                        Debug.Log(hit.point);
                    ...
                    //round 2
                    else if (counter == 2 & hit.collider.name == "3_W=2_D=16 Center (12.5, 4.5, 0)")                        
                    {
                        counter++;                                                                                          
                        Debug.Log(hit.point);
                    ...
                    else if (counter == 3 & hit.collider.name == "4_W=2_D=16 Center (12.5, 20.5, 0)")                       
                    {
                        counter++;                                                                                          
                        Debug.Log(hit.point);                                                                               
